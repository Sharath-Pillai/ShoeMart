...
const Footer = () => {
  return (
    <footer className="bg-gray-100 py-12 pb-24 md:pb-12">
      <div className="flex flex-col md:flex-row justify-between gap-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
