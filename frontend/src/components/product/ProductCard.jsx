...
const ProductCard = ({ product, variant = "grid" }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`relative ${variant === "list" ? "w-48 shrink-0" : "w-full"} bg-gray-50`}
        >
          {badgeLabel && (
          ...
          <img
            ...
            className={`object-contain transition duration-500 group-hover:scale-105 ${
              variant === "list" ? "h-48 w-full" : "h-60 w-full sm:h-64 md:h-72"
            }`}
          />
        </div>
