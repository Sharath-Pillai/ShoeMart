...
const ProductPage = () => {
  ...
  const product = useMemo(
    () => shoes.find((item) => String(item.id || item._id) === String(id)),
    [shoes, id],
  );
  // console.log(product)
  ...
  const loved = product ? isInWishlist?.(product._id) : false;
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <nav className="text-xs text-gray-500 mb-4">
          Home / {product.gender.toString().toLowerCase()} / Shoes
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded shadow-sm p-6">
              <div className="w-full bg-gray-100 rounded-md flex items-center justify-center h-105">
                <img
              ...
              <div className="mt-6">
                ...
                <div className="mt-3 grid grid-cols-3 gap-2 sm:grid-cols-6">
                  {sizeOptions.map((size) => {
                    const disabled = [12, 13].includes(size);
                    return (
                      <button
                        key={size}
