...
const CartPage = () => {
  ...
  const handleUpdateQuantity = (item, direction, currentQuantity) => {
    const nextQuantity =
      direction === "increase"
    ...
    updateQuantity(item.productId, item.color, item.size, nextQuantity);
  };
                ...
                >
                  <div className="flex flex-row gap-4">
                    <img
                      ...
                      className="h-24 w-24 sm:h-32 sm:w-32 rounded-xl bg-gray-50 object-contain shrink-0"
                    />
