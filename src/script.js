...
const App = () => {
    return (
        <div>
            ...
            <div className="main-container">
                <header>
                    <div className="left-header">
                        <div className="logo">
                            <img src="https://websitedemos.net/recycled-shoe-store-04/wp-content/uploads/sites/983/2021/11/site-logo.svg" alt="logo" />
                        </div>
                        <div>
                            <ul>
                                <li>MEN</li>
                ...
                <section className="hero">
                    <div className="banner" backgroundImage="url('https://websitedemos.net/recycled-shoe-store-04/wp-content/uploads/sites/983/2021/11/hero-image-1.jpg')">
                        <div className="banner-text">
                            <h1>Love the Planet <br /> we walk on</h1>
                            <p>Discover the latest arrivals from Recycled.</p>
            ...
            <div className="section1-container">
                ...
                <div className="aboutus">
                    <div className="left-aboutsection">
                        <img src="https://websitedemos.net/recycled-shoe-store-04/wp-content/uploads/sites/983/2021/11/recycled-shoe-store-home-about-image.jpg" alt="aboutusimage" />
                    </div>
                    <div className="right-aboutsection">
                        <h2>About Us</h2>
                        <h1>Selected materials designed for comfort and sustainability</h1>
            ...
            <div className="section2-container bg-gray-400" backgroundImage="url('https://websitedemos.net/recycled-shoe-store-04/wp-content/uploads/sites/983/2021/11/recycled-shoe-store-how-shoes-are-made-image.png')">
            ...
            <div className="section3-container">
                <div className="our-best-seller">
                    ...
                    <div className="card-container">
                        <div className="card">
                            <img src="https://websitedemos.net/recycled-shoe-store-04/wp-content/uploads/sites/983/2021/11/recycled-shoe-product-image-006-600x600.jpg" alt="shoe1" />
                            <h3>Title</h3>
                            <p>price</p>
                            <p>rating</p>
                        </div>
            ...
            <div className="section9-container">
                ...
                <div className="footer-links flex">
                    <div>
                        <img src="https://websitedemos.net/recycled-shoe-store/wp-content/uploads/sites/983/2021/11/site-logo.svg" alt="" />
