        ...
        <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
            ...
            <header className="bg-white border-b border-red-200">
                <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                    <a href="#" className="text-sm text-gray-600 hover:underline">&lt; All My Lists</a>
                    <nav className="flex items-center gap-6 text-sm text-gray-500">
                        <span>Shukrans</span>
                        <span>Purchases</span>
                        <span>My Reviews</span>
                        <span>Addresses</span>
                        <span>Shukran Pay</span>
            ...
            <main className="max-w-6xl mx-auto px-6 py-10">
                ...
                <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {Array.from({ length: 12 }).map((_, idx) => (
                        <article key={idx} className="bg-white border border-gray-100 rounded-lg shadow-sm p-4">
                            <div className="flex flex-col h-full">
                                <div className="relative">
                                    <img src={`https://images.unsplash.com/photo-1520975912044-6f5a6e0b8c6a?auto=format&fit=crop&w=500&q=60&fm=jpg&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8d2VhcnxlbnwwfHwwfHw%3D`} alt="product" className="h-40 w-full object-cover rounded-md" />
                                    ...
                                    <div className="absolute left-3 top-3 bg-white/90 px-2 py-1 rounded-full text-xs font-medium text-red-600 flex items-center gap-2 border border-red-100">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11V5a1 1 0 10-2 0v2a1 1 0 002 0zm-1 3a1 1 0 00-.707 1.707A1 1 0 0010 12a1 1 0 00.707-.293A1 1 0 0010 10z" clipRule="evenodd" />
                                        </svg>
                                ...
                                <div className="mt-4 flex-1 flex flex-col justify-between">
                                    <div>
                                        <p className="text-xl font-bold text-gray-900">QAR {[40, 9, 79, 15, 39, 15, 12, 45, 45, 49, 29, 19][idx % 12]}</p>
                                        ...
                                        <p className="mt-2 text-xs text-gray-500">Short description or detail goes here to mimic the design from the screenshot. This is only a layout placeholder.</p>
                                    </div>

                                    <div className="mt-4 flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            <button className="text-sm text-red-600 border border-red-100 px-3 py-1 rounded-full">Remove</button>
                                        </div>

                                        <div className="text-xs text-gray-400">
                                            <button className="flex items-center gap-1 text-sm text-gray-500 hover:underline" type="button">
                ...
                <footer className="mt-10 flex items-center justify-between">
                    <div className="text-sm text-gray-500">Showing 1–12 of 48 results</div>
                    <nav className="inline-flex items-center gap-2">
                        <button className="px-3 py-2 border border-gray-200 rounded-md text-sm">Previous</button>
                        ...
                        <button className="px-3 py-2 border border-gray-200 rounded-md text-sm">Next</button>
                    </nav>
                </footer>
