    ...
    if (Object.keys(newError).length === 0) {
      try {
        ...
        if (response.ok && data.success) {
          ...
          // Redirect to local admin dashboard directly
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-white to-orange-50 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white shadow-2xl rounded-2xl p-8 border border-orange-100">
          ...
          {/* Sign Up Link (External redirect to storefront) */}
          <div className="text-center mb-4">
            <p className="text-gray-600 text-sm mb-2">
              Don't have admin access?
            </p>
            <a
              href="https://shoe-mart-frontend.vercel.app/admin/signup"
          ...
          {/* Back to User Sign In (External redirect to storefront) */}
          <div className="text-center pt-4 border-t border-gray-100">
            <p className="text-gray-600 text-sm">
              Looking for regular sign in?
              <a
                href="https://shoe-mart-frontend.vercel.app/signin"
