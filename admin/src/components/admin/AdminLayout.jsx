...
const AdminLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-slate-50 font-sans text-slate-800 overflow-hidden relative">
      ...
      {/* Sidebar */}
      <aside
        className={`w-64 md:w-72 bg-slate-900 shadow-2xl flex flex-col absolute md:relative z-30 h-full transition-transform duration-300 ${isMobileOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}
      >
        <div className="p-6 md:p-8 border-b border-slate-800 flex items-center justify-between md:justify-center">
          <h1 className="text-2xl md:text-3xl font-extrabold text-cyan-400 tracking-wider uppercase drop-shadow-md">
      ...
      <div className="flex-1 flex flex-col overflow-hidden w-full">
        <header className="bg-white shadow-sm py-4 md:py-5 px-6 md:px-10 flex justify-between items-center z-10 border-b border-gray-100">
          <div className="flex items-center gap-4">
            <button
              className="md:hidden text-slate-600 text-2xl font-bold"
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-slate-800 font-bold tracking-wide hidden sm:block">
